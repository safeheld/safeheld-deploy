...
const navItems: NavItem[] = [
  ...
  { path: '/cass', label: 'CASS', icon: '§', roles: ['COMPLIANCE_OFFICER', 'FINANCE_OPS', 'AUDITOR', 'ADMIN'] },
  { path: '/crypto', label: 'Crypto', icon: '₿', roles: ['COMPLIANCE_OFFICER', 'FINANCE_OPS', 'AUDITOR', 'ADMIN'] },
  { path: '/stablecoin', label: 'Stablecoin', icon: '$', roles: ['COMPLIANCE_OFFICER', 'FINANCE_OPS', 'AUDITOR', 'ADMIN'] },
  ...
  { path: '/safeguarding-timing', label: 'Timing', icon: '◔', roles: ['COMPLIANCE_OFFICER', 'FINANCE_OPS', 'ADMIN'] },
