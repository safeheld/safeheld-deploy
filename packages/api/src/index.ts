...
import { stablecoinRouter } from './modules/stablecoin/routes';
import { legalRouter } from './modules/legal/routes';
import { insuranceRouter } from './modules/insurance/routes';
import { gamingRouter } from './modules/gaming/routes';
...
app.use('/api/v1/firms', generalLimiter, stablecoinRouter);
app.use('/api/v1/firms', generalLimiter, micaRouter);
app.use('/api/v1/firms', generalLimiter, geniusActRouter);
app.use('/api/v1/firms', generalLimiter, legalRouter);
